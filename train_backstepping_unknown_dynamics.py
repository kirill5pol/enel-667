...
CONST_ETA = 100  # The value of k_u_alpha_dot = 49.1493074 in the linearized version
...
def generate_unkown_dyn_labels(xs):
    ...
    ys = np.zeros((N, 2))
    ys[:, 0] = theta_dot_dots - alphas  # f2 = -x3 + θ̈ = θ̈ - α
    ys[:, 1] = alpha_dot_dots - CONST_ETA * alphas  # f4 = -η*u + α̈
    return ys
